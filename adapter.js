...
class Adapter {
    ...
    reconnect() {
        this.api.setOptions({ url: 'wss://one.weku.io:8190' });
this.config.set('address_prefix', "WEKU");
this.config.set('chain_id', "b24e09256ee14bab6d58bfa3a4e47b0474a73ef4d6c47eeea007848195fa085e");
    }
